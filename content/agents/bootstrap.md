...
1. First, invoke the `/plan` command to generate `plans/PLAN_{NAME}.md`
...
main() {
  ...
  echo ""
  echo "Next steps:"
  echo "  1. Review plans/PLAN_{NAME}.md for implementation plan"
...
```
✅ Plan generated at `plans/PLAN_{NAME}.md`
